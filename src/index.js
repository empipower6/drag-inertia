...
export class DragInertia extends React.Component{
 ...
 moving(e){
   ...
   render(){
       ...
       return(
        ...
        <div ref={el=> this.dragObj =el} className={styles.box} style={{left:this.state.posX+`px`,top:this.state.posY+`px`}} onMouseDown={this.mouseDown} onMouseOut={this.state.clicked ? this.moving:null} onMouseUp={this.mouseUp} onMouseMove={this.state.clicked ? this.moving:null}  > {this.props.children}</div>
